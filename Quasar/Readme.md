...
[Discord](https://discord.gg/quasarfi) | [Website](https://www.quasar.fi/) | [Medium](https://medium.com/@quasar.fi)
--- | --- | ---
...
#### Initializing 
```Shell
quasard init "name_moniker" --chain-id qsr-questnet-04
quasard config keyring-backend test
quasard config chain-id qsr-questnet-04
```

#### Download genesis and adrbook
```Shell
...
```Shell
# создать кошелек
quasard  keys add <name_wallet> --keyring-backend os

# восстановить кошелек (после команды вставить seed)
quasard  keys add <name_wallet> --recover --keyring-backend os

# восстановить кошелек для EVM сетей
quasard  keys add <name_wallet> --recover --coin-type 118 --algo secp256k1
```
...
cd $HOME && \
rm -rf .quasarnode GHFkqmTzpdNLDd6T && \
rm -rf $(which quasard)
```
