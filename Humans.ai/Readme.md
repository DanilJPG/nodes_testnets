...
[Useful commands](https://github.com/DanilJPG/nodes_testnets/blob/main/Humans.ai/Useful%20commands.md) | Here are commands for the validator, for node management and for the wallet
